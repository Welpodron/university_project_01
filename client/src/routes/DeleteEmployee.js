              ...
              {checked.map((el) => (
                <section key={el.Id}>
                  ...
                  <div className="mb-2">
                    <p>
                      Фамилия:{" "}
                      <span class="badge bg-dark p-2">{el.LastName}</span>
                    </p>
                  </div>
                  <div className="mb-2">
                    <p>
                      Имя: <span class="badge bg-dark p-2">{el.FirstName}</span>
                    </p>
                  </div>
                  {el.MiddleName && (
                    <div className="mb-2">
                      <p>
                        Отчество:{" "}
                        <span class="badge bg-dark p-2">{el.MiddleName}</span>
                      </p>
                    </div>
                  )}
                  <div className="mb-2">
                    <p>
                      ...
                      <span class="badge bg-dark p-2">{`${el.PassportSerial} ${el.PassportNumber}`}</span>
                    </p>
                  </div>
                  <div className="mb-2">
                    <p>
                      Текущая должность:{" "}
                      <span class="badge bg-dark p-2">{el.Job}</span>
                    </p>
                  </div>
                  <div className="mb-2">
                    <p>
                      Текущий отдел:{" "}
                      <span class="badge bg-dark p-2">{el.Dep}</span>
                    </p>
                  </div>
                  <div className="mb-2">
